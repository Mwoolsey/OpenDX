...
#endif
#ifndef __linesII1DClass
#define __linesII1DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct linesii1dinterpolator_class _dxdlinesii1dinterpolator_class;
Error _dxfLinesII1DInterpolator_PrimitiveInterpolate(LinesII1DInterpolator, int *, float **, Pointer *, int);
Error _dxfLinesII1DInterpolator_Delete(LinesII1DInterpolator);
Object _dxfLinesII1DInterpolator_Copy(LinesII1DInterpolator, enum _dxd_copy);
Interpolator _dxfLinesII1DInterpolator_LocalizeInterpolator(LinesII1DInterpolator);
...
struct linesii1dinterpolator_class _dxdlinesii1dinterpolator_class = {
    sizeof(struct linesii1dinterpolator),
    CLASS_LINESII1DINTERPOLATOR,
    "linesii1dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfLinesII1DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfLinesII1DInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfLinesII1DInterpolator_LocalizeInterpolator,
    CLASS_LINESII1DINTERPOLATOR,
    "linesii1dinterpolator",
    _dxfLinesII1DInterpolator_PrimitiveInterpolate,
    CLASS_LINESII1DINTERPOLATOR,
    "linesii1dinterpolator",
};

Class DXGetLinesII1DInterpolatorClass(LinesII1DInterpolator o) {
    return o? (*(struct linesii1dinterpolator_class **)o)->class: CLASS_MIN;
}
