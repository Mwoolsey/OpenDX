...
#endif
#ifndef __cubesIIClass
#define __cubesIIClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct cubesiiinterpolator_class _dxdcubesiiinterpolator_class;
Error _dxfCubesIIInterpolator_PrimitiveInterpolate(CubesIIInterpolator, int *, float **, Pointer *, int);
Error _dxfCubesIIInterpolator_Delete(CubesIIInterpolator);
Object _dxfCubesIIInterpolator_Copy(CubesIIInterpolator, enum _dxd_copy);
Interpolator _dxfCubesIIInterpolator_LocalizeInterpolator(CubesIIInterpolator);
...
struct cubesiiinterpolator_class _dxdcubesiiinterpolator_class = {
    sizeof(struct cubesiiinterpolator),
    CLASS_CUBESIIINTERPOLATOR,
    "cubesiiinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfCubesIIInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfCubesIIInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfCubesIIInterpolator_LocalizeInterpolator,
    CLASS_CUBESIIINTERPOLATOR,
    "cubesiiinterpolator",
    _dxfCubesIIInterpolator_PrimitiveInterpolate,
    CLASS_CUBESIIINTERPOLATOR,
    "cubesiiinterpolator",
};

Class DXGetCubesIIInterpolatorClass(CubesIIInterpolator o) {
    return o? (*(struct cubesiiinterpolator_class **)o)->class: CLASS_MIN;
}
