...
#endif
#ifndef __tetrasClass
#define __tetrasClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct tetrasinterpolator_class _dxdtetrasinterpolator_class;
Error _dxfTetrasInterpolator_PrimitiveInterpolate(TetrasInterpolator, int *, float **, Pointer *, int);
Error _dxfTetrasInterpolator_Delete(TetrasInterpolator);
Object _dxfTetrasInterpolator_Copy(TetrasInterpolator, enum _dxd_copy);
Interpolator _dxfTetrasInterpolator_LocalizeInterpolator(TetrasInterpolator);
...
struct tetrasinterpolator_class _dxdtetrasinterpolator_class = {
    sizeof(struct tetrasinterpolator),
    CLASS_TETRASINTERPOLATOR,
    "tetrasinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfTetrasInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfTetrasInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfTetrasInterpolator_LocalizeInterpolator,
    CLASS_TETRASINTERPOLATOR,
    "tetrasinterpolator",
    _dxfTetrasInterpolator_PrimitiveInterpolate,
    CLASS_TETRASINTERPOLATOR,
    "tetrasinterpolator",
};

Class DXGetTetrasInterpolatorClass(TetrasInterpolator o) {
    return o? (*(struct tetrasinterpolator_class **)o)->class: CLASS_MIN;
}
