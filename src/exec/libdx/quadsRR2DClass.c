...
#endif
#ifndef __quadsRR2DClass
#define __quadsRR2DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct quadsrr2dinterpolator_class _dxdquadsrr2dinterpolator_class;
Error _dxfQuadsRR2DInterpolator_PrimitiveInterpolate(QuadsRR2DInterpolator, int *, float **, Pointer *, int);
Error _dxfQuadsRR2DInterpolator_Delete(QuadsRR2DInterpolator);
Object _dxfQuadsRR2DInterpolator_Copy(QuadsRR2DInterpolator, enum _dxd_copy);
Interpolator _dxfQuadsRR2DInterpolator_LocalizeInterpolator(QuadsRR2DInterpolator);
...
struct quadsrr2dinterpolator_class _dxdquadsrr2dinterpolator_class = {
    sizeof(struct quadsrr2dinterpolator),
    CLASS_QUADSRR2DINTERPOLATOR,
    "quadsrr2dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfQuadsRR2DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfQuadsRR2DInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfQuadsRR2DInterpolator_LocalizeInterpolator,
    CLASS_QUADSRR2DINTERPOLATOR,
    "quadsrr2dinterpolator",
    _dxfQuadsRR2DInterpolator_PrimitiveInterpolate,
    CLASS_QUADSRR2DINTERPOLATOR,
    "quadsrr2dinterpolator",
};

Class DXGetQuadsRR2DInterpolatorClass(QuadsRR2DInterpolator o) {
    return o? (*(struct quadsrr2dinterpolator_class **)o)->class: CLASS_MIN;
}
