...
**/
#endif
#ifndef __clippedClass
#define __clippedClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct clipped_class _dxdclipped_class;

Object _dxfClipped_Copy(Clipped, enum _dxd_copy);
Object _dxfClipped_BoundingBox(Clipped, Point*, Matrix*, int);
Error _dxfClipped_Delete(Clipped);
Object _dxfClipped_Gather(Clipped, struct gather *, struct tile *);
Object _dxfClipped_Paint(Clipped, struct buffer *, int, struct tile *);
Error _dxfClipped_Shade(Clipped, struct shade *);
