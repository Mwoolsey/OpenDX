...
#endif
#ifndef __linesRI1DClass
#define __linesRI1DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct linesri1dinterpolator_class _dxdlinesri1dinterpolator_class;
Error _dxfLinesRI1DInterpolator_PrimitiveInterpolate(LinesRI1DInterpolator, int *, float **, Pointer *, int);
Error _dxfLinesRI1DInterpolator_Delete(LinesRI1DInterpolator);
Object _dxfLinesRI1DInterpolator_Copy(LinesRI1DInterpolator, enum _dxd_copy);
Interpolator _dxfLinesRI1DInterpolator_LocalizeInterpolator(LinesRI1DInterpolator);
...
struct linesri1dinterpolator_class _dxdlinesri1dinterpolator_class = {
    sizeof(struct linesri1dinterpolator),
    CLASS_LINESRI1DINTERPOLATOR,
    "linesri1dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfLinesRI1DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfLinesRI1DInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfLinesRI1DInterpolator_LocalizeInterpolator,
    CLASS_LINESRI1DINTERPOLATOR,
    "linesri1dinterpolator",
    _dxfLinesRI1DInterpolator_PrimitiveInterpolate,
    CLASS_LINESRI1DINTERPOLATOR,
    "linesri1dinterpolator",
};

Class DXGetLinesRI1DInterpolatorClass(LinesRI1DInterpolator o) {
    return o? (*(struct linesri1dinterpolator_class **)o)->class: CLASS_MIN;
}
