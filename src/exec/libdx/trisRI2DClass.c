...
#endif
#ifndef __trisRI2DClass
#define __trisRI2DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct trisri2dinterpolator_class _dxdtrisri2dinterpolator_class;
Error _dxfTrisRI2DInterpolator_PrimitiveInterpolate(TrisRI2DInterpolator, int *, float **, Pointer *, int);
Error _dxfTrisRI2DInterpolator_Delete(TrisRI2DInterpolator);
Object _dxfTrisRI2DInterpolator_Copy(TrisRI2DInterpolator, enum _dxd_copy);
Interpolator _dxfTrisRI2DInterpolator_LocalizeInterpolator(TrisRI2DInterpolator);
...
struct trisri2dinterpolator_class _dxdtrisri2dinterpolator_class = {
    sizeof(struct trisri2dinterpolator),
    CLASS_TRISRI2DINTERPOLATOR,
    "trisri2dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfTrisRI2DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfTrisRI2DInterpolator_LocalizeInterpolator,
    CLASS_TRISRI2DINTERPOLATOR,
    "trisri2dinterpolator",
    _dxfTrisRI2DInterpolator_PrimitiveInterpolate,
    CLASS_TRISRI2DINTERPOLATOR,
    "trisri2dinterpolator",
};

Class DXGetTrisRI2DInterpolatorClass(TrisRI2DInterpolator o) {
    return o? (*(struct trisri2dinterpolator_class **)o)->class: CLASS_MIN;
}
