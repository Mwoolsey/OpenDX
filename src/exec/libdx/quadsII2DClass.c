...
#endif
#ifndef __quadsII2DClass
#define __quadsII2DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct quadsii2dinterpolator_class _dxdquadsii2dinterpolator_class;
Error _dxfQuadsII2DInterpolator_PrimitiveInterpolate(QuadsII2DInterpolator, int *, float **, Pointer *, int);
Error _dxfQuadsII2DInterpolator_Delete(QuadsII2DInterpolator);
Object _dxfQuadsII2DInterpolator_Copy(QuadsII2DInterpolator, enum _dxd_copy);
Interpolator _dxfQuadsII2DInterpolator_LocalizeInterpolator(QuadsII2DInterpolator);
...
struct quadsii2dinterpolator_class _dxdquadsii2dinterpolator_class = {
    sizeof(struct quadsii2dinterpolator),
    CLASS_QUADSII2DINTERPOLATOR,
    "quadsii2dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfQuadsII2DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfQuadsII2DInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfQuadsII2DInterpolator_LocalizeInterpolator,
    CLASS_QUADSII2DINTERPOLATOR,
    "quadsii2dinterpolator",
    _dxfQuadsII2DInterpolator_PrimitiveInterpolate,
    CLASS_QUADSII2DINTERPOLATOR,
    "quadsii2dinterpolator",
};

Class DXGetQuadsII2DInterpolatorClass(QuadsII2DInterpolator o) {
    return o? (*(struct quadsii2dinterpolator_class **)o)->class: CLASS_MIN;
}
