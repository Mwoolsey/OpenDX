...
extern struct fle2dinterpolator_class _dxdfle2dinterpolator_class;
Error _dxfFle2DInterpolator_PrimitiveInterpolate(Fle2DInterpolator, int *, float **, Pointer *, int);
Error _dxfFle2DInterpolator_Delete(Fle2DInterpolator);
Object _dxfFle2DInterpolator_Copy(Fle2DInterpolator, enum _dxd_copy);
Interpolator _dxfFle2DInterpolator_LocalizeInterpolator(Fle2DInterpolator);
...
struct fle2dinterpolator_class _dxdfle2dinterpolator_class = {
    sizeof(struct fle2dinterpolator),
    CLASS_FLE2DINTERPOLATOR,
    "fle2dinterpolator",
    CLASS_INTERPOLATOR,
    "interpolator",
    _dxfFle2DInterpolator_Delete,
    _dxfObject_Shade,
    ...
    _dxfFle2DInterpolator_Copy,
    CLASS_FIELDINTERPOLATOR,
    "fieldinterpolator",
    _dxfFieldInterpolator_Interpolate,
    _dxfFle2DInterpolator_LocalizeInterpolator,
    CLASS_FLE2DINTERPOLATOR,
    "fle2dinterpolator",
    _dxfFle2DInterpolator_PrimitiveInterpolate,
    CLASS_FLE2DINTERPOLATOR,
    "fle2dinterpolator",
};

Class DXGetFle2DInterpolatorClass(Fle2DInterpolator o) {
    return o? (*(struct fle2dinterpolator_class **)o)->class: CLASS_MIN;
}
