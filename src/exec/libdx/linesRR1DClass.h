...
#endif
#ifndef __linesRR1DClass
#define __linesRR1DClass
/***********************************************************************/
/* Open Visualization Data Explorer                                    */
/* (C) Copyright IBM Corp. 1989,1999                                   */
/* ALL RIGHTS RESERVED                                                 */
...
extern struct linesrr1dinterpolator_class _dxdlinesrr1dinterpolator_class;
Error _dxfLinesRR1DInterpolator_PrimitiveInterpolate(LinesRR1DInterpolator, int *, float **, Pointer *, int);
Error _dxfLinesRR1DInterpolator_Delete(LinesRR1DInterpolator);
Object _dxfLinesRR1DInterpolator_Copy(LinesRR1DInterpolator, enum _dxd_copy);
Interpolator _dxfLinesRR1DInterpolator_LocalizeInterpolator(LinesRR1DInterpolator);
