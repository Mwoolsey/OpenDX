...
#define LoadPolyhedronPoints()     \
  {                                \
    LoadFacetPoints( 0, 1, 3, 2 ); \
    ds++;                          \
    LoadFacetPoints( 1, 5, 7, 3 ); \
    ds++;                          \
    LoadFacetPoints( 5, 4, 6, 7 ); \
    ds++;                          \
    LoadFacetPoints( 6, 2, 0, 4 ); \
    ds++;                          \
    LoadFacetPoints( 0, 4, 5, 1 ); \
    ds++;                          \
    LoadFacetPoints( 3, 2, 6, 7 ); \
    ds++;                          \
  }

#define LoadPolyhedronPointsAndCmapColors()   \
  LoadFacetPointsAndCmapColors( 0, 1, 3, 2 ); \
  ds++;                                       \
  LoadFacetPointsAndCmapColors( 1, 5, 7, 3 ); \
  ds++;                                       \
  LoadFacetPointsAndCmapColors( 5, 4, 6, 7 ); \
  ds++;                                       \
  LoadFacetPointsAndCmapColors( 6, 2, 0, 4 ); \
  ds++;                                       \
  LoadFacetPointsAndCmapColors( 0, 4, 5, 1 ); \
  ds++;                                       \
  LoadFacetPointsAndCmapColors( 3, 2, 6, 7 ); \
  ds++;

#define LoadPolyhedronPointsAndCdirColors()   \
  LoadFacetPointsAndCdirColors( 0, 1, 3, 2 ); \
  ds++;                                       \
  LoadFacetPointsAndCdirColors( 1, 5, 7, 3 ); \
  ds++;                                       \
  LoadFacetPointsAndCdirColors( 5, 4, 6, 7 ); \
  ds++;                                       \
  LoadFacetPointsAndCdirColors( 6, 2, 0, 4 ); \
  ds++;                                       \
  LoadFacetPointsAndCdirColors( 0, 4, 5, 1 ); \
  ds++;                                       \
  LoadFacetPointsAndCdirColors( 3, 2, 6, 7 ); \
  ds++;
