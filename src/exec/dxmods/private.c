 ...
 */
Error _dxf_private_modules()
{
  {
    DXAddModule(
        "MacroStart", m_MacroStart, MODULE_PASSTHRU, 51, "count", "i00", "i01",
        "i02", "i03", "i04", "i05", "i06", "i07", "i08", "i09", "i10", "i11",
        "i12", "i13", "i14", "i15", "i16", "i17", "i18", "i19", "i20", "i21",
        "i22", "i23", "i24", "i25", "i26", "i27", "i28", "i29", "i30", "i31",
        "i32", "i33", "i34", "i35", "i36", "i37", "i38", "i39", "i40", "i41",
        "i42", "i43", "i44", "i45", "i46", "i47", "i48", "i49", 50, "o00",
  ...
  }
  {
    ...
    DXAddModule( "MacroEnd", m_MacroEnd, MODULE_LOOP | MODULE_ERR_CONT, 51,
                 "count", "i00", "i01", "i02", "i03", "i04", "i05", "i06",
