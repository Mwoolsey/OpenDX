 ...
 _dxf_user_modules()
{
    ...
    }
    {
        ...
        DXAddModule("Integer", m_Integer, 
            ...
            11, "id[visible:2]", "data[cache:2]", "value[visible:2,reroute:0]", "refresh[visible:0,cache:2]", "min[visible:0,cache:2]", "max[visible:0,cache:2]", "delta[visible:0,cache:2]", "method[visible:0,cache:2]", "reserved2[visible:2]", "start[visible:0]", "label[visible:0,cache:2]",
            1, "output");
    }
    {
#if defined(__cplusplus)
    ...
    }
    {
        ...
        DXAddModule("Scalar", m_Scalar, 
            MODULE_REROUTABLE | MODULE_REACH,
            11, "id[visible:2]", "data[cache:2]", "value[visible:2,reroute:0]", "refresh[visible:0,cache:2]", "min[visible:0,cache:2]", "max[visible:0,cache:2]", "delta[visible:0,cache:2]", "method[visible:0,cache:2]", "decimals[visible:0,cache:2]", "start[visible:0]", "label[visible:0,cache:2]",
            1, "output");
    }
    {
#if defined(__cplusplus)
