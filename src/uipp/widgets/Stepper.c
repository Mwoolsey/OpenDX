...
static Boolean SetValues( XmStepperWidget current, XmStepperWidget request,
                          XmStepperWidget new );
...
static void Arm( XmStepperWidget sw, XButtonPressedEvent *event );
static void Activate( XmStepperWidget sw, XButtonPressedEvent *event );
static void CallFromNumber( Widget w, XmStepperWidget sw,
...
static Boolean IncrementStepper( XmStepperWidget sw, Boolean increase,
                                 double step_size );
...
static XtGeometryResult PreferredSize( XmStepperWidget, XtWidgetGeometry *,
                                       XtWidgetGeometry * );
...
static Boolean UpdateMultitypeData( XmStepperWidget sw, MultitypeData *new,
...
static XtActionsRec actionsList[] = {{"Arm", (XtActionProc)Arm},
...
#if defined( hp700 ) || defined( solaris ) || defined( sun4 ) || \
    defined( aviion ) || defined( intelnt ) || defined( OS2 )
...
static XtResource resources[] = {
    {XmNdataType,                                    XmCDataType,
     ...
     XtOffset( XmStepperWidget, stepper.data_type ), XmRImmediate,
     (XtPointer)INTEGER},
    {XmNdValue,                                    XmCDValue,
     XmRDouble,                                    sizeof( double ),
     XtOffset( XmStepperWidget, stepper.value.d ), XmRDouble,
     ( XtPointer ) & DefaultValDbl},
    {XmNfValue,                                    XmCFValue,
     XmRFloat,                                     sizeof( float ),
     XtOffset( XmStepperWidget, stepper.value.f ), XmRFloat,
     ( XtPointer ) & DefaultValFlt},
    {XmNiValue,                                    XmCIValue,
     XmRInt,                                       sizeof( int ),
     XtOffset( XmStepperWidget, stepper.value.i ), XmRImmediate,
     (XtPointer)DEF_VALUE},
    {XmNdMinimum,                                          XmCDMinimum,
     XmRDouble,                                            sizeof( double ),
     XtOffset( XmStepperWidget, stepper.value_minimum.d ), XmRDouble,
     ( XtPointer ) & DefaultMinDbl},
    {XmNfMinimum,                                          XmCFMinimum,
     XmRFloat,                                             sizeof( float ),
     XtOffset( XmStepperWidget, stepper.value_minimum.f ), XmRFloat,
     ( XtPointer ) & DefaultMinFlt},
    {XmNiMinimum,                                          XmCIMinimum,
     XmRInt,                                               sizeof( int ),
     XtOffset( XmStepperWidget, stepper.value_minimum.i ), XmRImmediate,
     ( XtPointer ) - 1000000},
    {XmNdMaximum,                                          XmCDMaximum,
     XmRDouble,                                            sizeof( double ),
     XtOffset( XmStepperWidget, stepper.value_maximum.d ), XmRDouble,
     ( XtPointer ) & DefaultMaxDbl},
    {XmNfMaximum,                                          XmCFMaximum,
     XmRFloat,                                             sizeof( float ),
     XtOffset( XmStepperWidget, stepper.value_maximum.f ), XmRFloat,
     ( XtPointer ) & DefaultMaxFlt},
    {XmNiMaximum,                                          XmCIMaximum,
     XmRInt,                                               sizeof( int ),
     XtOffset( XmStepperWidget, stepper.value_maximum.i ), XmRImmediate,
     (XtPointer)1000000},
    {XmNdValueStep,                                     XmCDValueStep,
     XmRDouble,                                         sizeof( double ),
     XtOffset( XmStepperWidget, stepper.value_step.d ), XmRDouble,
     ( XtPointer ) & DefaultStepDbl},
    {XmNfValueStep,                                     XmCFValueStep,
     XmRFloat,                                          sizeof( float ),
     XtOffset( XmStepperWidget, stepper.value_step.f ), XmRFloat,
     ( XtPointer ) & DefaultStepFlt},
    {XmNiValueStep,                                     XmCIValueStep,
     XmRInt,                                            sizeof( int ),
     XtOffset( XmStepperWidget, stepper.value_step.i ), XmRImmediate,
     (XtPointer)1},
    {XmNdigits,                                       XmCDigits,
     XmRCardinal,                                     sizeof( Cardinal ),
     XtOffset( XmStepperWidget, stepper.num_digits ), XmRImmediate,
     (XtPointer)8},
    {XmNdecimalPlaces,                                    XmCDecimalPlaces,
     XmRInt,                                              sizeof( int ),
     XtOffset( XmStepperWidget, stepper.decimal_places ), XmRImmediate,
     (XtPointer)0},
    {XmNtime,                                            XmCTime,
     XmRCardinal,                                        sizeof( Cardinal ),
     XtOffset( XmStepperWidget, stepper.time_interval ), XmRImmediate,
     (XtPointer)200},
    {XmNtimeDelta,                                     XmCTimeDelta,
     XmRCardinal,                                      sizeof( Cardinal ),
     XtOffset( XmStepperWidget, stepper.time_ddelta ), XmRImmediate,
     (XtPointer)8},
    {XmNarmCallback,                                     XmCArmCallback,
     XmRCallback,                                        sizeof( XtPointer ),
     XtOffset( XmStepperWidget, stepper.step_callback ), XmRCallback,
     NULL},
    {XmNactivateCallback,
     XmCActivateCallback,
     XmRCallback,
     ...
     XmRCallback,
     NULL},
    {XmNincreaseDirection,
     XmCIncreaseDirection,
     XmRArrowDirection,
    ...
    {XmNcenter,                                        XmCCenter,
     ...
     XtOffset( XmStepperWidget, stepper.center_text ), XmRImmediate,
     (XtPointer)TRUE},
    {XmNeditable,                                   XmCEditable,
     XmRBoolean,                                    sizeof( Boolean ),
     XtOffset( XmStepperWidget, stepper.editable ), XmRImmediate,
     (XtPointer)TRUE},
    {XmNrollOver,                                    XmCRollOver,
     XmRBoolean,                                     sizeof( Boolean ),
     XtOffset( XmStepperWidget, stepper.roll_over ), XmRImmediate,
     (XtPointer)FALSE},
    {XmNrecomputeSize,                                      XmCRecomputeSize,
     XmRBoolean,                                            sizeof( Boolean ),
     XtOffset( XmStepperWidget, stepper.resize_to_number ), XmRImmediate,
     (XtPointer)TRUE},
    {XmNfixedNotation,                              XmCFixedNotation,
     XmRBoolean,                                    sizeof( Boolean ),
     XtOffset( XmStepperWidget, stepper.is_fixed ), XmRImmediate,
     (XtPointer)TRUE},
    {XmNwarningCallback,                                    XmCCallback,
     XmRCallback,                                           sizeof( XtPointer ),
     XtOffset( XmStepperWidget, stepper.warning_callback ), XmRCallback,
     NULL},
    {XmNalignment,                                   XmCAlignment,
     XmRAlignment,                                   sizeof( unsigned char ),
     XtOffset( XmStepperWidget, stepper.alignment ), XmRImmediate,
...
static XtGeometryResult PreferredSize( XmStepperWidget step,
                                       XtWidgetGeometry *prop,
                                       XtWidgetGeometry *resp )
{
  struct layout needs;
...
static void Initialize( XmStepperWidget request, XmStepperWidget new )
{
  ...
  XtAddCallback( new->stepper.child[0], XmNwarningCallback,
                 (XtCallbackProc)WarningCallback, new );
  ...
  new->stepper.child[1] =
      XmCreateArrowButton( ( Widget ) new, "left", wargs, 7 );
  ...
  new->stepper.child[2] =
      XmCreateArrowButton( ( Widget ) new, "right", wargs, 7 );
  ...
  XQueryColor( XtDisplay( new ), DefaultColormapOfScreen( XtScreen( new ) ),
               &fg_cell_def );
  ...
  if ( ( new->stepper.increase_direction == XmARROW_DOWN ) ||
       ( new->stepper.increase_direction == XmARROW_RIGHT ) )
  {
    XtAddCallback( new->stepper.child[2], XmNarmCallback,
                   (XtCallbackProc)ButtonIncrease, new );
    XtAddCallback( new->stepper.child[1], XmNarmCallback,
                   (XtCallbackProc)ButtonDecrease, new );
  }
  else
  {
    XtAddCallback( new->stepper.child[1], XmNarmCallback,
  ...
  XtAddCallback( new->stepper.child[1], XmNdisarmCallback,
                 (XtCallbackProc)ButtonIsReleased, new );
  XtAddCallback( new->stepper.child[2], XmNdisarmCallback,
                 (XtCallbackProc)ButtonIsReleased, new );
  XtAddCallback( new->stepper.child[0], XmNactivateCallback,
                 (XtCallbackProc)CallFromNumber, new );
  XtAddCallback( new->stepper.child[0], XmNarmCallback,
                 (XtCallbackProc)CallFromNumber, new );
  XtAddCallback( new->stepper.child[0], XmNdisarmCallback,
                 (XtCallbackProc)CallFromNumber, new );
                                         ...
                                         XtWidgetGeometry *reply )
{
       ...
       ( request->height != w->core.height ) )
  {
    ...
    if ( XtMakeResizeRequest( stepper, new_width, new_height, &ret_w,
                              &ret_h ) == XtGeometryYes )
    {
                          ...
                          XmStepperWidget new )
{
  ...
  SyncMultitypeData( &new->stepper.value_step, new->stepper.data_type );
  VerifyValueRange(
      new, new->stepper.value_step.d != current->stepper.value_step.d );
  i = 0;
  ...
  if ( UpdateMultitypeData( new, &new->stepper.value,
...
*/
    ...
    if ( expon2 < 0 )
    {
      if ( ( -expon2 > sw->stepper.decimal_places ) &&
           ( ( ( value < cross_under ) && ( value > 0 ) ) ||
             ( ( -value < cross_under ) && ( value < 0 ) ) ) )
        expon = pow( (double)10, (double)sw->stepper.decimal_places - expon2 );
      else
    ...
    else
    {
      if ( ( expon2 > sw->stepper.decimal_places ) &&
           ( ( ( value > cross_over ) && ( value > 0 ) ) ||
             ( ( -value > cross_over ) && ( value < 0 ) ) ) )
        expon =
            1 / pow( (double)10, (double)expon2 - sw->stepper.decimal_places );
      else
        expon = pow( (double)10, (double)sw->stepper.decimal_places );
    }
    value = value * expon;
  ...
  if ( value != sw->stepper.value.d )
  {
    ...
    if ( sw->composite.children[0] )
      XmChangeNumberValue( (XmNumberWidget)sw->composite.children[0], value );
  }
                               ...
                               XtCallbackProc callback_proc )
{
  ...
  sw->stepper.timer =
      XtAppAddTimeOut( XtWidgetToApplicationContext( w ), sw->stepper.interval,
                       (XtTimerCallbackProc)RepeatDigitButton, sw );
  return TRUE;
}
 ...
 */
Widget XmCreateStepper( Widget parent, String name, ArgList args,
                        Cardinal num_args )
{
