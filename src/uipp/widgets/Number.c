...
extern void SetNumberSize( XmNumberWidget nw, Dimension *width,
                           Dimension *height );
...
static Boolean UpdateMultitypeData( XmNumberWidget nw, MultitypeData *new,
...
static XtResource resources[] = {
    {XmNdValue,                                  XmCDValue,
     ...
     XtOffset( XmNumberWidget, number.value.d ), XmRDouble,
     ( XtPointer ) & DefaultValueDbl},
    {XmNfValue,                                  XmCFValue,
     XmRFloat,                                   sizeof( float ),
     XtOffset( XmNumberWidget, number.value.f ), XmRFloat,
     ( XtPointer ) & DefaultValueFlt},
    {XmNiValue,                                  XmCIValue,
     XmRInt,                                     sizeof( int ),
     XtOffset( XmNumberWidget, number.value.i ), XmRImmediate,
     (XtPointer)DEF_IVAL},
    {XmNdMinimum,                                        XmCDMinimum,
     XmRDouble,                                          sizeof( double ),
     XtOffset( XmNumberWidget, number.value_minimum.d ), XmRDouble,
     ( XtPointer ) & DefaultMinDbl},
    {XmNfMinimum,                                        XmCFMinimum,
     XmRFloat,                                           sizeof( float ),
     XtOffset( XmNumberWidget, number.value_minimum.f ), XmRFloat,
     ( XtPointer ) & DefaultMinFlt},
    {XmNiMinimum,                                        XmCIMinimum,
     XmRInt,                                             sizeof( int ),
     XtOffset( XmNumberWidget, number.value_minimum.i ), XmRImmediate,
     (XtPointer)DEF_IMIN},
    {XmNdMaximum,                                        XmCDMaximum,
     XmRDouble,                                          sizeof( double ),
     XtOffset( XmNumberWidget, number.value_maximum.d ), XmRDouble,
     ( XtPointer ) & DefaultMaxDbl},
    {XmNfMaximum,                                        XmCFMaximum,
     XmRFloat,                                           sizeof( float ),
     XtOffset( XmNumberWidget, number.value_maximum.f ), XmRFloat,
     ( XtPointer ) & DefaultMaxFlt},
    {XmNiMaximum,                                        XmCIMaximum,
     XmRInt,                                             sizeof( int ),
     XtOffset( XmNumberWidget, number.value_maximum.i ), XmRImmediate,
     (XtPointer)DEF_IMAX},
    {XmNfontList,                                  XmCFontList,
     XmRFontList,                                  sizeof( XmFontList ),
     XtOffset( XmNumberWidget, number.font_list ), XmRString,
     "Fixed"},
    {XmNcharPlaces,                                  XmCCharPlaces,
     XmRShort,                                       sizeof( short ),
     XtOffset( XmNumberWidget, number.char_places ), XmRImmediate,
     (XtPointer)4},
    {XmNdecimalPlaces,                                  XmCDecimalPlaces,
     XmRShort,                                          sizeof( short ),
     XtOffset( XmNumberWidget, number.decimal_places ), XmRImmediate,
     (XtPointer)0},
    {XmNdataType,                                  XmCDataType,
     XmRShort,                                     sizeof( short ),
     XtOffset( XmNumberWidget, number.data_type ), XmRImmediate,
     (XtPointer)INTEGER},
    {XmNoverflowCallback,
     XmCCallback,
     XmRCallback,
     ...
     XmRPointer,
     (XtPointer)NULL},
    {XmNarmCallback,                                  XmCArmCallback,
     XmRCallback,                                     sizeof( XtCallbackList ),
     XtOffset( XmNumberWidget, number.arm_callback ), XmRPointer,
     (XtPointer)NULL},
    {XmNactivateCallback,
     XmCActivateCallback,
     XmRCallback,
    ...
    {XmNwarningCallback,
     ...
     XmRPointer,
     (XtPointer)NULL},
    {XmNcenter,         XmCCenter,                                 XmRBoolean,
     sizeof( Boolean ), XtOffset( XmNumberWidget, number.center ), XmRImmediate,
     (XtPointer)True},
    {XmNraised,         XmCRaised,                                 XmRBoolean,
     sizeof( Boolean ), XtOffset( XmNumberWidget, number.raised ), XmRImmediate,
     (XtPointer)False},
    {XmNvisible,                                 XmCVisible,
     XmRBoolean,                                 sizeof( Boolean ),
     XtOffset( XmNumberWidget, number.visible ), XmRImmediate,
     (XtPointer)True},
    {XmNeditable,                                             XmCEditable,
     XmRBoolean,                                              sizeof( Boolean ),
     XtOffset( XmNumberWidget, number.allow_key_entry_mode ), XmRImmediate,
     (XtPointer)False},
    {XmNnoEvents,                                         XmCNoEvents,
     XmRBoolean,                                          sizeof( Boolean ),
     XtOffset( XmNumberWidget, number.propogate_events ), XmRImmediate,
     (XtPointer)False},
    {XmNrecomputeSize,                                  XmCRecomputeSize,
     XmRBoolean,                                        sizeof( Boolean ),
     XtOffset( XmNumberWidget, number.recompute_size ), XmRImmediate,
     (XtPointer)TRUE},
    {XmNfixedNotation,                            XmCFixedNotation,
     XmRBoolean,                                  sizeof( Boolean ),
     XtOffset( XmNumberWidget, editor.is_fixed ), XmRImmediate,
     (XtPointer)True},
    {XmNcrossOver,                                  XmCCrossOver,
     XmRDouble,                                     sizeof( double ),
     XtOffset( XmNumberWidget, number.cross_over ), XmRDouble,
     ( XtPointer ) & DefaultCrossOver},
    {XmNcrossUnder,                                  XmCCrossUnder,
     XmRDouble,                                      sizeof( double ),
     XtOffset( XmNumberWidget, number.cross_under ), XmRDouble,
     ( XtPointer ) & DefaultCrossUnder}, };
...
static Boolean DifferentBackground( Widget w, Widget parent )
{
...
static void Activate( XmNumberWidget nw, XEvent *event )
{
  ...
  if ( XtHasCallbacks( (Widget)nw, XmNactivateCallback ) == XtCallbackHasSome )
  {
...
#if ( XmVersion > 1001 )
  XSetInputFocus( XtDisplay( nw ), PointerRoot, RevertToPointerRoot,
                  CurrentTime );
#endif
#endif
}
 ...
 */
/* ARGSUSED */
static void SelfInsert( XmNumberWidget nw, XEvent *event, char **params,
                        Cardinal *num_params )
#ifdef EXPLAIN
    XmNumberWidget nw;
XEvent *event;
...
/* ARGSUSED */
static void DeleteForwardChar( XmNumberWidget nw, XEvent *event, char **params,
                               Cardinal *num_params )
{
  if ( nw->number.key_entry_mode )
  {
...
/* ARGSUSED */
static void DeleteBackwardChar( XmNumberWidget nw, XEvent *event, char **params,
                                Cardinal *num_params )
{
  if ( nw->number.key_entry_mode )
  {
...
/* ARGSUSED */
static void MoveBackwardChar( XmNumberWidget nw, XEvent *event, char **params,
                              Cardinal *num_params )
{
...
/* ARGSUSED */
static void MoveForwardChar( XmNumberWidget nw, XEvent *event, char **params,
                             Cardinal *num_params )
{
  if ( nw->number.key_entry_mode && MovePosition( nw, 1 ) )
    UpdateNumberEditorDisplay( nw );
...
/* ARGSUSED */
static void MoveToLineStart( XmNumberWidget nw, XEvent *event, char **params,
                             Cardinal *num_params )
{
...
/* ARGSUSED */
static void MoveToLineEnd( XmNumberWidget nw, XEvent *event, char **params,
                           Cardinal *num_params )
{
  if ( nw->number.key_entry_mode && MovePosition( nw, nw->editor.string_len ) )
    UpdateNumberEditorDisplay( nw );
 ...
 */
static Boolean TestParse( XmNumberWidget nw, char *in_string,
                          int insert_position )
{
  int i, j;
  ...
  if ( in_string[i] == DECIMAL_POINT )
  {
    ...
    while ( isdigit( in_string[i] ) )
    {
      if ( nw->editor.is_fixed && ( decimal < nw->editor.decimal_minimum ) )
      {
 ...
 *		feedback.
 */
static Boolean DXEditError( XmNumberWidget nw, char *string, int msg,
                            int char_place )
{
  char message[100];
                     ...
                     XSetWindowAttributes *attributes )
{
  ...
  XtCreateWindow( (Widget)nw, InputOutput, CopyFromParent, valueMask,
                  attributes );
}
...
static void DisplayNumberShadow( XmNumberWidget nw )
{
...
#if ( OLD_LESSTIF != 1 )
#if ( XmVersion < 2000 )
    _XmDrawShadow( XtDisplay( nw ), XtWindow( nw ), nw->primitive.top_shadow_GC,
  ...
  else
  {
    _XmDrawShadow( XtDisplay( nw ), XtWindow( nw ),
                   nw->primitive.bottom_shadow_GC, nw->primitive.top_shadow_GC,
                   nw->primitive.shadow_thickness, border, border,
                   nw->core.width - borders, nw->core.height - borders );
#else  /* XmVersion >= 2000 */
    XmeDrawShadows( XtDisplay( nw ), XtWindow( nw ),
                    nw->primitive.top_shadow_GC, nw->primitive.bottom_shadow_GC,
                    border, border, nw->core.width - borders,
                    nw->core.height - borders, nw->primitive.shadow_thickness,
                    XmSHADOW_IN );
  }
  else
  {
                                       ...
                                       XtWidgetGeometry *preferred )
{
  ...
  borders = 2 * ( nw->primitive.highlight_thickness +
                  nw->primitive.shadow_thickness );
  min_width = nw->number.width + borders;
#if 0
    min_height = nw->number.height + borders;
#else
  min_height = nw->number.font_struct->ascent +
               nw->number.font_struct->descent + 2 + borders;
#endif
...

{
       ...
       ( new->number.decimal_places != current->number.decimal_places ) )
  {
    ...
    call_value.message = "XmNdecimalPlaces resource should not be modified\nif "
                         "XmNdataType resource is set to INTEGER.";
...
static void GetNumberGC( XmNumberWidget nw )
{
...
#if ( XmVersion < 1001 )
      int index;
      _XmFontListSearch( nw->number.font_list, XmSTRING_DEFAULT_CHARSET, &index,
                         &nw->number.font_struct );
#else
  ...
  XQueryColor( XtDisplay( nw ), DefaultColormapOfScreen( XtScreen( nw ) ),
               &fg_cell_def );
  ...
  if ( !XAllocColor( XtDisplay( nw ), DefaultColormapOfScreen( XtScreen( nw ) ),
                     &fg_cell_def ) )
  {
 ...
 */
Widget XmCreateNumber( Widget parent, String name, ArgList args,
                       Cardinal num_args )
#ifdef EXPLAIN
...
static void UpdateNumberEditorDisplay( XmNumberWidget nw )
{
  ...
  if ( nw->editor.string_len < nw->number.last_char_cnt )
    XClearArea( XtDisplay( nw ), XtWindow( nw ), nw->number.x, nw->number.y,
                nw->number.width + nw->number.h_margin, nw->number.height,
                False );
  ...
  XDrawImageString( XtDisplay( nw ), XtWindow( nw ), nw->number.gc, x, y,
                    nw->editor.string, nw->editor.string_len );
  x += XTextWidth( nw->number.font_struct, nw->editor.string,
                   nw->editor.insert_position );
  DrawCursor( nw, x, y, 2 );
...
static void DrawCursor( XmNumberWidget nw, int x, int y, int type )
{
  ...
  switch ( type )
  {
    case 0:
      /*  Underbar  */
      XDrawLine( XtDisplay( nw ), XtWindow( nw ), nw->number.gc, x, y,
                 x + nw->number.char_width, y );
      break;
    case 1:
      /*  Vertical line  */
      XDrawLine( XtDisplay( nw ), XtWindow( nw ), nw->number.gc, x,
                 nw->number.y, x, nw->number.y + nw->number.height - 1 );
      break;
    case 2:
      /*  I beam  */
      ...
      XDrawSegments( XtDisplay( nw ), XtWindow( nw ), nw->number.gc, segment,
                     3 );
      break;
  }
}
...
void XmSetNumberBounds( XmNumberWidget w, double dmin, double dmax )
{
  ...
  else if ( type == FLOAT )
  {
    fmin = dmin;
    fmax = dmax;
    XtSetArg( wargs[n], XmNfMinimum, &fmin );
    n++;
    XtSetArg( wargs[n], XmNfMaximum, &fmax );
    n++;
  }
  else
  {
    imin = dmin;
    imax = dmax;
    XtSetArg( wargs[n], XmNiMinimum, imin );
    n++;
    XtSetArg( wargs[n], XmNiMaximum, imax );
    n++;
  }
  ...
  switch ( type )
  {
    ...
    case FLOAT:
      ...
      *dmax = fmax;
      break;
    case DOUBLE:
      XtSetArg( wargs[n], XmNdMinimum, dmin );
      n++;
      XtSetArg( wargs[n], XmNdMaximum, dmax );
      n++;
      XtGetValues( (Widget)w, wargs, n );
      break;
  }
