...
class ToggleNode : public InteractorNode
{
 private:
  ...
  //
  boolean changeToggleValues( const char *set, const char *reset, int how );
 ...
 protected:
  ...
  virtual boolean netParseAuxComment( const char *comment, const char *filename,
                                      int lineno );
 ...
 public:
  ...
  //
  boolean set( boolean send = TRUE )
  {
    return this->setToggle( TRUE, send );
  }
  boolean reset( boolean send = TRUE )
  {
    return this->setToggle( FALSE, send );
  }
  ...
  char *getSetValue()
  {
    return this->getToggleValue( TRUE );
  }
  char *getResetValue()
  {
    return this->getToggleValue( FALSE );
  }
