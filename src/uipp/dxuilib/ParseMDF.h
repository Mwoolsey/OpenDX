...
extern boolean ReadMDFFiles( const char* root, Dictionary* mdf,
                             boolean uiOnly );
extern boolean LoadMDFFile( const char* file, const char* type, Dictionary* mdf,
                            boolean uiOnly );
extern boolean ParseMDFTypes( ParameterDefinition* param, char* line,
                              int lineNumber = 0 );
