...
String LabeledStandIn::DefaultResources[] = {NULL};

//
// Static allocator found in theSIAllocatorDictionary
//
StandIn *LabeledStandIn::AllocateStandIn( WorkSpace *w, Node *node )
{
...
LabeledStandIn::LabeledStandIn( WorkSpace *w, Node *node ) : StandIn( w, node )
{
}
