...
extern "C" void InstallShutdownTimer( Widget w, XtPointer clientData,
                                      XtPointer calldata );
...
// Resources below
#if 1
static XrmOptionDescRec _DXOptionList[] = {
    {(char *)"-directory", (char *)"*directory", XrmoptionSepArg, (char *)NULL},
    {(char *)"-edit", (char *)"*anchorMode",
     XrmoptionNoArg,  (char *)EDIT_ANCHOR_MODE},
    {(char *)"-exec", (char *)"*executive", XrmoptionSepArg, (char *)NULL},
    {(char *)"-execute", (char *)"*executeProgram",
     XrmoptionNoArg,     (char *)"True"},
    {(char *)"-execute_on_change", (char *)"*executeOnChange",
     XrmoptionNoArg,               (char *)"True"},
    {(char *)"-help", (char *)"*printHelpMessage",
     XrmoptionNoArg,  (char *)"True"},
    {(char *)"-host", (char *)"*host", XrmoptionSepArg, (char *)NULL},
    {(char *)"-image", (char *)"*anchorMode",
     XrmoptionNoArg,   (char *)IMAGE_ANCHOR_MODE},
    {(char *)"-kiosk", (char *)"*anchorMode",
     XrmoptionNoArg,   (char *)MENUBAR_ANCHOR_MODE},
    {(char *)"-menubar", (char *)"*anchorMode",
     XrmoptionNoArg,     (char *)MENUBAR_ANCHOR_MODE},
    {(char *)"-noAnchorAtStartup", (char *)"*noAnchorAtStartup",
     XrmoptionNoArg,               (char *)"True"},
    {(char *)"-noConfirmedQuit", (char *)"*noConfirmedQuit",
     XrmoptionNoArg,             (char *)"True"},
    {(char *)"-local", (char *)"*runLocally", XrmoptionNoArg, (char *)"True"},
    {(char *)"-macros", (char *)"*macros", XrmoptionSepArg, (char *)NULL},
    {(char *)"-mdf",  (char *)"*userModuleDescriptionFile",
     XrmoptionSepArg, (char *)NULL},
    {(char *)"-metric", (char *)"*metric", XrmoptionNoArg, (char *)"True"},
    {(char *)"-dxmdf", (char *)"*executiveModuleDescriptionFile",
     XrmoptionSepArg,  (char *)NULL},
    {(char *)"-uimdf", (char *)"*uiModuleDescriptionFile",
     XrmoptionSepArg,  (char *)NULL},
    {(char *)"-memory", (char *)"*memory", XrmoptionSepArg, (char *)NULL},
    {(char *)"-port", (char *)"*port", XrmoptionSepArg, (char *)NULL},
    {(char *)"-printImageCommand", (char *)"*printImageCommand",
     XrmoptionSepArg,              (char *)NULL},
    {(char *)"-printImageFormat", (char *)"*printImageFormat",
     XrmoptionSepArg,             (char *)NULL},
    {(char *)"-printImagePageSize", (char *)"*printImagePageSize",
     XrmoptionSepArg,               (char *)NULL},
    {(char *)"-printImageSize", (char *)"*printImageSize",
     XrmoptionSepArg,           (char *)NULL},
    {(char *)"-printImageResolution", (char *)"*printImageResolution",
     XrmoptionSepArg,                 (char *)NULL},
    {(char *)"-program", (char *)"*program", XrmoptionSepArg, (char *)NULL},
    {(char *)"-cfg", (char *)"*cfg", XrmoptionSepArg, (char *)NULL},
    {(char *)"-saveImageFormat", (char *)"*saveImageFormat",
     XrmoptionSepArg,            (char *)NULL},
    {(char *)"-saveImagePageSize", (char *)"*saveImagePageSize",
     XrmoptionSepArg,              (char *)NULL},
    {(char *)"-saveImageSize", (char *)"*saveImageSize",
     XrmoptionSepArg,          (char *)NULL},
    {(char *)"-saveImageResolution", (char *)"*saveImageResolution",
     XrmoptionSepArg,                (char *)NULL},
    {(char *)"-suppress", (char *)"*suppressStartupWindows",
     XrmoptionNoArg,      (char *)"True"},
    {(char *)"-uidebug", (char *)"*debugMode", XrmoptionNoArg, (char *)"True"},
    {(char *)"-showInstanceNumbers", (char *)"*showInstanceNumbers",
     XrmoptionNoArg,                 (char *)"True"},
    {(char *)"-uionly", (char *)"*runUIOnly", XrmoptionNoArg, (char *)"True"},
    {(char *)"-uimessages", (char *)"*messages", XrmoptionSepArg, (char *)NULL},
    {(char *)"-version", (char *)"*DXVersion", XrmoptionNoArg, (char *)"True"},

    //
    // Backdoor switches:
    //
    {(char *)"-restrictionLevel", (char *)"*restrictionLevel",
     XrmoptionSepArg,             (char *)NULL},
    {(char *)"-appHost", (char *)"*applicationHost",
     XrmoptionSepArg,    (char *)NULL, },
    {(char *)"-appPort", (char *)"*applicationPort",
     XrmoptionSepArg,    (char *)NULL, },
    {(char *)"-noDXHelp", (char *)"*noDXHelp", XrmoptionNoArg, (char *)"True"},
    {(char *)"-noEditorAccess", (char *)"*noEditorAccess",
     XrmoptionNoArg,            (char *)"True"},
    {(char *)"-notifySaveNet", (char *)"*notifySaveNet",
     XrmoptionNoArg,           (char *)"True"},
    {(char *)"-noNetworkExecute", (char *)"*noNetworkExecute",
     XrmoptionNoArg,              (char *)"True"},
    {(char *)"-noImageRWNetFile", (char *)"*noImageRWNetFile",
     XrmoptionNoArg,              (char *)"True"},
    {(char *)"-noImageLoad", (char *)"*noImageLoad",
     XrmoptionNoArg,         (char *)"True"},
    {(char *)"-limitImageOptions", (char *)"*limitImageOptions",
     XrmoptionNoArg,               (char *)"True"},
    {(char *)"-limitedNetFileSelection",  // Used to be
                                          // limitedImageFileSelection
     (char *)"*limitedNetFileSelection", XrmoptionNoArg, (char *)"True"},
    {(char *)"-noNetFileSelection", (char *)"*noNetFileSelection",
     XrmoptionNoArg,                (char *)"True"},
    {(char *)"-noImageSaving", (char *)"*noImageSaving",
     XrmoptionNoArg,           (char *)"True"},
    {(char *)"-noImagePrinting", (char *)"*noImagePrinting",
     XrmoptionNoArg,             (char *)"True"},
    {(char *)"-noInteractorEdits", (char *)"*noInteractorEdits",
     XrmoptionNoArg,               (char *)"True"},
    {(char *)"-noInteractorAttributes", (char *)"*noInteractorAttributes",
     XrmoptionNoArg,                    (char *)"True"},
    {(char *)"-noInteractorMovement", (char *)"*noInteractorMovement",
     XrmoptionNoArg,                  (char *)"True"},
    {(char *)"-noOpenAllPanels", (char *)"*noOpenAllPanels",
     XrmoptionNoArg,             (char *)"True"},
    {(char *)"-noPanelAccess", (char *)"*noPanelAccess",
     XrmoptionNoArg,           (char *)"True"},
    {(char *)"-noPanelOptions", (char *)"*noPanelOptions",
     XrmoptionNoArg,            (char *)"True"},
    {(char *)"-noPanelEdit", (char *)"*noPanelEdit",
     XrmoptionNoArg,         (char *)"True"},
    {(char *)"-noRWConfig", (char *)"*noRWConfig",
     XrmoptionNoArg,        (char *)"True"},
    {(char *)"-noScriptCommands", (char *)"*noScriptCommands",
     XrmoptionNoArg,              (char *)"True"},
    {(char *)"-noMessageInfoOption", (char *)"*noMessageInfoOption",
     XrmoptionNoArg,                 (char *)"True"},
    {(char *)"-noMessageWarningOption", (char *)"*noMessageWarningOption",
     XrmoptionNoArg,                    (char *)"True"},
    {(char *)"-noEditorOnError", (char *)"*noEditorOnError",
     XrmoptionNoArg,             (char *)"True"},
    {(char *)"-noCMapSetNameOption", (char *)"*noCMapSetNameOption",
     XrmoptionNoArg,                 (char *)"True"},
    {(char *)"-noCMapSaveMap", (char *)"*noCMapSaveMap",
     XrmoptionNoArg,           (char *)"True"},
    {(char *)"-noWindowPlacement", (char *)"*noWindowPlacement",
     XrmoptionNoArg,               (char *)"True"},
    {(char *)"-noCMapOpenMap", (char *)"*noCMapOpenMap",
     XrmoptionNoArg,           (char *)"True"},
    {(char *)"-netPath", (char *)"*netPath", XrmoptionSepArg, (char *)NULL, },
    {(char *)"-noPGroupAssignment", (char *)"*noPGroupAssignment",
     XrmoptionNoArg,                (char *)"True"},
    {(char *)"-warning", (char *)"*warningEnabled",
     XrmoptionNoArg,     (char *)"False"},
    {(char *)"-info", (char *)"*infoEnabled", XrmoptionNoArg, (char *)"False"},
    {(char *)"-error", (char *)"*errorEnabled",
     XrmoptionNoArg,   (char *)"False"},
    {(char *)"-forceNetFileEncryption", (char *)"*forceNetFileEncryption",
     XrmoptionSepArg,                   (char *)NULL},
    {(char *)"-cryptKey", (char *)"*cryptKey", XrmoptionSepArg, (char *)NULL},
    {(char *)"-exitAfter", (char *)"*exitAfter",
     XrmoptionNoArg,       (char *)"True"},
    {(char *)"-forceLicense", (char *)"*forceLicense",
     XrmoptionSepArg,         (char *)NULL, },
    ...
    {(char *)"-noExitOptions", (char *)"*noExitOptions",
     XrmoptionNoArg,           (char *)"True", },
    {(char *)"-noImageMenus", (char *)"*noImageMenus",
     XrmoptionNoArg,          (char *)"True", },
    {(char *)"-view", (char *)"*viewDataFile", XrmoptionSepArg, (char *)NULL, },
    {(char *)"-noAutoScrollVPE", (char *)"*autoScrollVPE",
     XrmoptionNoArg,             (char *)"False"},
    {(char *)"-autoLayoutHeight", (char *)"*autoLayoutHeight",
     XrmoptionSepArg,             (char *)NULL},
    {(char *)"-autoLayoutGroupSpacing", (char *)"*autoLayoutGroupSpacing",
     XrmoptionSepArg,                   (char *)NULL},
    {(char *)"-autoLayoutNodeSpacing", (char *)"*autoLayoutNodeSpacing",
     XrmoptionSepArg,                  (char *)NULL}, };
...
extern "C" void TurnOffButtonHelp( Widget /* widget */, XEvent * /* event */,
                                   String * /* params */,
                                   Cardinal * /* num_params */ )
{
  return;
...
DXApplication::DXApplication( char *className ) : IBMApplication( className )
{
  ...
  //
  this->quitCmd =
      new ConfirmedQuitCommand( "quit", this->commandScope, TRUE, this );

  this->exitCmd =
      new ConfirmedExitCommand( "exit", this->commandScope, TRUE, this );

  this->openFileCmd = new OpenCommand( "open", this->commandScope, TRUE, this );

  this->messageWindowCmd =
      new NoUndoDXAppCommand( "messageWindowCmd", this->commandScope, TRUE,
                              this, NoUndoDXAppCommand::OpenMessageWindow );

  this->openSequencerCmd =
      new NoUndoDXAppCommand( "openSequencerCmd", this->commandScope, FALSE,
                              this, NoUndoDXAppCommand::OpenSequencer );

  this->openAllColormapCmd =
      new NoUndoDXAppCommand( "openAllColormapCmd", this->commandScope, FALSE,
                              this, NoUndoDXAppCommand::OpenAllColormaps );

  this->loadMacroCmd =
      new NoUndoDXAppCommand( "Load Macro Command", this->commandScope, TRUE,
                              this, NoUndoDXAppCommand::LoadMacro );

  this->executeOnceCmd =
      new NoUndoDXAppCommand( "Execute Once", this->commandScope, FALSE, this,
                              NoUndoDXAppCommand::ExecuteOnce );

  this->executeOnChangeCmd =
      new NoUndoDXAppCommand( "Execute On Change", this->commandScope, FALSE,
                              this, NoUndoDXAppCommand::ExecuteOnChange );

  this->endExecutionCmd =
      new NoUndoDXAppCommand( "End Execution", this->commandScope, FALSE, this,
  ...
  this->connectToServerCmd =
      new NoUndoDXAppCommand( "Start Server", this->commandScope, TRUE, this,
                              NoUndoDXAppCommand::StartServer );

  this->resetServerCmd =
      new NoUndoDXAppCommand( "Reset Server", this->commandScope, FALSE, this,
                              NoUndoDXAppCommand::ResetServer );

  this->disconnectFromServerCmd = new DisconnectFromServerCommand(
      "Disconnect From Server...", this->commandScope, FALSE );

#if USE_REMAP  // 6/14/93
  this->toggleRemapInteractorsCmd = new NoUndoDXAppCommand(
      "Remap Interactor Outputs...", this->commandScope, TRUE, this,
      NoUndoDXAppCommand::RemapInteractorOutputs );
#endif
  this->loadMDFCmd =
      new NoUndoDXAppCommand( "Load MDF...", this->commandScope, TRUE, this,
                              NoUndoDXAppCommand::LoadUserMDF );

  this->toggleInfoEnable =
      new NoUndoDXAppCommand( "Enable Information", this->commandScope, TRUE,
                              this, NoUndoDXAppCommand::ToggleInfoEnable );
  this->toggleWarningEnable =
      new NoUndoDXAppCommand( "Enable Warnings", this->commandScope, TRUE, this,
                              NoUndoDXAppCommand::ToggleWarningEnable );
  this->toggleErrorEnable =
      new NoUndoDXAppCommand( "Enable Errors", this->commandScope, TRUE, this,
                              NoUndoDXAppCommand::ToggleErrorEnable );
  this->assignProcessGroupCmd =
      new NoUndoDXAppCommand( "assignProcessGroup", this->commandScope, TRUE,
                              this, NoUndoDXAppCommand::AssignProcessGroup );
  ...
  this->disconnectedFromServerCmd->autoDeactivate(
...
void DXApplication::loadIDF()
{
  ...
  char s[1000];
  if ( *this->resource.uiModule == '/' || *this->resource.uiModule == '.' )
...
void DXApplication::InitializeSignals( void )
{
...
boolean DXApplication::initialize( unsigned int *argcp, char **argv )
{
  ...
  for ( j = 0; j < XtNumber( _DXResourceList ); j++ )
  {
    if ( !strcmp( _DXResourceList[j].resource_type, XmRPixel ) )
    {
      ...
      toinout.addr = ( XPointer ) & tmp_pixel;
      toinout.size = sizeof( Pixel );
      XtConvertAndStore( this->getRootWidget(), XmRString, &from, XmRPixel,
                         &toinout );
    }
  }
  ...
  */
  ...
  if ( NOT DXApplication::DXApplicationClassInitialized )
  {
    ...
    DXApplication::MsgExecute = theSymbolManager->registerSymbol( "Execute" );
    DXApplication::MsgStandBy = theSymbolManager->registerSymbol( "StandBy" );
...
#endif
        theApplication->getFormalName(), DX_MAJOR_VERSION, DX_MINOR_VERSION,
        DX_MICRO_VERSION, __TIME__, __DATE__ );
    exit( 0 );
  }
  ...
  if ( DXApplication::resource.autoLayoutHeight > 0 )
  {
    const char *errmsg = GraphLayout::SetHeightPerLevel(
        DXApplication::resource.autoLayoutHeight );
    if ( errmsg )
    {
  ...
  if ( DXApplication::resource.autoLayoutGroupSpacing > 0 )
  {
    const char *errmsg = GraphLayout::SetGroupSpacing(
        DXApplication::resource.autoLayoutGroupSpacing );
    if ( errmsg )
    {
      fprintf( stderr, errmsg );
  ...
  if ( DXApplication::resource.autoLayoutNodeSpacing > 0 )
  {
    const char *errmsg = GraphLayout::SetNodeSpacing(
        DXApplication::resource.autoLayoutNodeSpacing );
    if ( errmsg )
    {
      fprintf( stderr, errmsg );
  ...
  if ( this->appAllowsImageRWNetFile() && this->appLimitsNetFileSelection() &&
       ( this->resource.netPath == NULL ) )
  {
    fprintf( stderr, "The \"limitedNetFileSelection\" or \"noImageRWNetFile\" "
  ...
  this->serverInfo.server = DuplicateString( DXApplication::resource.server );
  this->serverInfo.executive =
      DuplicateString( DXApplication::resource.executive );
  this->serverInfo.workingDirectory =
      DuplicateString( DXApplication::resource.workingDirectory );
  this->serverInfo.userModules =
      DuplicateString( DXApplication::resource.userModules );
  ...
  else
  {
    ...
    else if ( this->appLicenseType == TimedLicense )
    {
      ...
      InstallShutdownTimer( NULL, ( XtPointer )( LICENSED_MINUTES * 60 ),
                            NULL );
    }
  }
  ...
  {
    theResourceManager->registerMultiValued(
        DXApplication::ListValuedSettings[i] );
    i++;
  }
...
#define START_SERVER_EARLY 0  // Not right before 3.1 release
  ...
  if ( this->hasClipnotifyExtension =
           XQueryExtension( this->display, CLIPNOTIFY_PROTOCOL_NAME, &majorCode,
                            &this->clipnotifyEventCode, &errorCode ) )
  {
    XSetWindowAttributes attributes;
    Window win = XCreateWindow( this->display, RootWindow( this->display, 0 ),
                                0, 0, 10, 10, 2, 8, CopyFromParent,
                                CopyFromParent, NULL, &attributes );
...
static void printEvent( Widget w, XtPointer, String actname, XEvent *xev,
                        String *, Cardinal * )
{
...
#if NEED_TO_WATCH_EVENTS
  XtAppAddActionHook( this->applicationContext, (XtActionHookProc)printEvent,
                      NULL );
#endif
...
void DXApplication::handleEvent( XEvent *xev )
{
#ifdef HAS_CLIPNOTIFY_EXTENSION
  if ( this->hasClipnotifyExtension &&
       ( ( xev->type - this->clipnotifyEventCode ) == ClipNotifyHdrError ) )
  {
    char message[1000];
    XClipNotifyHdrErrorEvent *pHdr = (XClipNotifyHdrErrorEvent *)xev;
    sprintf( message, "HPPI header error: "
              ...
              ClipNotifyDataErrors ) )
  {
    ...
    sprintf( message, "HPPI data error:   "
                      "serial# = %d, send_event = %d, window = %d,"
                      " number of errors = %d, elapsed time in seconds = %d",
             pData->serial, pData->send_event, pData->window, pData->num_errors,
             pData->etime );
    XtWarning( message );
  }
#endif
...
DXChild *DXApplication::startServer()
{
  ...
  if ( this->serverInfo.autoStart )
  {
    ...
    if ( this->serverInfo.memorySize > 0 )
      sprintf( args, "-exonly -memory %d -local", this->serverInfo.memorySize );
    else
...
static char *GetErrorNode( char *path, char *name, int *instance )
{
  ...
  if ( (nameptr =
            strchr( name, '_' ))AND( strncmp( nameptr, "_Image", 6 ) == 0 ) )
    strcpy( name, "Image" );
...
void DXApplication::highlightNodes( char *path, int highlightType )
{
  ...
  while ( path )
  {
    ...
    for ( network = (Network *)li.getNext(); network;
...
int DXApplication::connectToServer( int port, DXChild *c )
{
  ...
  DXPacketIF *p =
      new DXPacketIF( server, port, DXChild::HostIsLocal( server ) );
  ...
  else
  {
    ...
    sprintf( s, "Your connection to server %s has been accepted.  Do you want "
                "to disconnect from %s and connect to it?",
             server, this->serverInfo.server );
    theQuestionDialogManager->modalPost(
        this->getRootWidget(), s, NULL, (void *)p,
        DXApplication::QueuedPacketAccept, DXApplication::QueuedPacketCancel,
        NULL );
  }
  return ( TRUE );
}
...
boolean DXApplication::resetServer()
{
  ...
  if ( pif )
  {  // pif should really never be NULL, but...
    ...
    sprintf( message, "Executive(\"version %d %d %d\");\n", PIF_MAJOR_VERSION,
             PIF_MINOR_VERSION, PIF_MICRO_VERSION );
...
void DXApplication::getServerParameters( int *autoStart, const char **server,
                                         const char **executive,
                                         const char **workingDirectory,
                                         const char **executiveFlags, int *port,
                                         int *memorySize )
{
  if ( autoStart )
...
void DXApplication::setServerParameters( int autoStart, const char *server,
                                         const char *executive,
                                         const char *workingDirectory,
                                         const char *executiveFlags, int port,
                                         int memorySize )
{
  char *tserver = server ? DuplicateString( server ) : NULL;
  char *texecutive = executive ? DuplicateString( executive ) : NULL;
...
void DXApplication::completeConnection( DXChild *c )
{
  if ( c != NULL )
  {
    ...
    switch ( c->waitForConnection() )
    {
      ...
      case 1:
        sprintf( s, "Connection to server %s has been queued", c->getServer() );
        InfoMessage( s );
        break;
    }
  }
...
void DXApplication::postOpenNetworkDialog()
{
  if ( this->openNetworkDialog == NULL )
  {
    this->openNetworkDialog =
        new OpenNetworkDialog( this->anchor->getRootWidget() );

    if ( this->appLimitsNetFileSelection() )
    {
      ASSERT( this->resource.netPath );
      this->openNetworkDialog->setReadOnlyDirectory( this->resource.netPath );
    }
  }
...
void DXApplication::postLoadMacroDialog()
{
  ...
  {
    this->loadMacroDialog =
        new LoadMacroDialog( this->anchor->getRootWidget() );
  }
...
void DXApplication::connectToApplication( const char *host, const int port )
{
  ...
  this->applicationPacket =
      new ApplicIF( host, port, DXChild::HostIsLocal( host ) );

  this->applicationPacket->initializePacketIO();

  if ( DXApplication::resource.debugMode )
    this->applicationPacket->setEchoCallback( DXApplication::DebugEchoCallback,
                                              (void *)NULL );
}
...
{
  if ( ( !this->isErrorEnabled() ) || ( net->wasNetFileEncoded() ) ||
...
void DXApplication::postLoadMDFDialog()
{
  ...
  {
    this->loadMDFDialog =
        new LoadMDFDialog( this->anchor->getRootWidget(), this );
  }
...
void DXApplication::postProcessGroupAssignDialog()
{
  if ( NOT this->processGroupAssignDialog )
    this->processGroupAssignDialog = new ProcessGroupAssignDialog( this );
...
//
void DXApplication::sendNewMDFToServer( Dictionary *newdefs,
                                        Dictionary *current )
{
  char *buf = NULL;
  ...
  while ( ( nd = (NodeDefinition *)di.getNextDefinition() ) )
  {
    ...
    {
      Symbol s = nd->getNameSymbol();
      NodeDefinition *olddef = (NodeDefinition *)current->findDefinition( s );
      if ( olddef )
      {
        //
...
boolean DXApplication::isRestrictionLevel( int level )
{
  ...
  {
    case 3:
      if ( EqualString( "minimum", rlev ) )
        return TRUE;
    case 2:
      if ( EqualString( "intermediate", rlev ) )
        return TRUE;
    case 1:
      if ( EqualString( "maximum", rlev ) )
        return TRUE;
    default:
      return FALSE;
  }
...
{
  return !this->isRestrictionLevel( SOMEWHAT_RESTRICTED ) &&
         this->appAllowsPanelEdit() && !this->resource.noInteractorAttributes;
}
boolean DXApplication::appAllowsInteractorEdits()
{
  return !this->isRestrictionLevel( MINIMALLY_RESTRICTED ) &&
         this->appAllowsPanelEdit() && !this->resource.noInteractorEdits;
}
...
{
  return this->appAllowsSavingCfgFile() && ( !n || !n->wasNetFileEncoded() );
}
...
boolean DXApplication::appAllowsEditorAccess()
{
  ...
  return !this->isRestrictionLevel( MINIMALLY_RESTRICTED ) &&
         !this->resource.noEditorAccess && ( func != RunTimeLicense );
}
...
const char *DXApplication::getFormalName()
{
  const char *s = this->getOEMApplicationName();
  if ( !s )
    s = "Open Visualization Data Explorer";
  return s;
}
//
...
boolean DXApplication::verifyServerLicense()
{
  ...
  pif->setHandler( DXPacketIF::INFORMATION, DXApplication::LicenseMessage,
                   (void *)this, "LICENSE:" );
...
extern "C" void InstallShutdownTimer( Widget w, XtPointer clientData,
                                      XtPointer calldata );
extern "C" void ShutdownApplication( Widget w, XtPointer clientData,
                                     XtPointer callData );
...
{
  if ( this->funcLicenseType == UndeterminedLicense )
  {  // not determined yet
    if ( this->isFunctionalLicenseForced() )
...
static char *format_seconds( int seconds )
{
  ...
  if ( minutes == 0 )
    ...
    sprintf( buf, "%d minute%s %d seconds", minutes, minutes == 1 ? "" : "s",
             frac );
  else
...
extern "C" void ShutdownTimeout( XtPointer clientData, XtIntervalId *id )
{
  ...
  if ( seconds > MIN_INTERVAL )
  {
    ...
    sprintf( buffer, "You do not have a license to run %s.\n"
                     "You have %s %s",
             theApplication->getInformalName(), format_seconds( seconds ),
    ...
    if ( save_files )
    {
      ...
      for ( i = 0; write_error && dirs[i]; i++ )
      {
        ...
        for ( n = theDXApplication->network, cnt = 0, write_error = FALSE;
              n && !write_error; n = (Network *)li.getNext() )
        {
...
extern "C" int DXApplication_DXAfterFunction( Display *display )
{
  ...
  XQueryPointer( display, win, &root, &child, &root_x, &root_y, &win_x, &win_y,
                 &key_buttons );
...
boolean DXApplication::parseComment( const char *comment, const char *filename,
                                     int lineno )
{
...
//
// C H E C K   B E T A   B U I L D   D A T E     C H E C K   B E T A   B U I L D
// D A T E
// C H E C K   B E T A   B U I L D   D A T E     C H E C K   B E T A   B U I L D
// D A T E
// C H E C K   B E T A   B U I L D   D A T E     C H E C K   B E T A   B U I L D
...
#define BETA_SECONDS ( BETA_DAYS * 24 * 60 * 60 )
  ...
  iMonth = 0;
  if ( strnicmp( szMonth, "Jan", 3 ) == 0 )
    iMonth = 1;
  if ( strnicmp( szMonth, "Feb", 3 ) == 0 )
    iMonth = 2;
  if ( strnicmp( szMonth, "Mar", 3 ) == 0 )
    iMonth = 3;
  if ( strnicmp( szMonth, "Apr", 3 ) == 0 )
    iMonth = 4;
  if ( strnicmp( szMonth, "May", 3 ) == 0 )
    iMonth = 5;
  if ( strnicmp( szMonth, "Jun", 3 ) == 0 )
    iMonth = 6;
  if ( strnicmp( szMonth, "Jul", 3 ) == 0 )
    iMonth = 7;
  if ( strnicmp( szMonth, "Aug", 3 ) == 0 )
    iMonth = 8;
  if ( strnicmp( szMonth, "Sep", 3 ) == 0 )
    iMonth = 9;
  if ( strnicmp( szMonth, "Oct", 3 ) == 0 )
    iMonth = 10;
  if ( strnicmp( szMonth, "Nov", 3 ) == 0 )
    iMonth = 11;
  if ( strnicmp( szMonth, "Dec", 3 ) == 0 )
    iMonth = 12;
...
#define NORMAL_TIMEZONE_CONVERSION
  ...
  static int cum_yday[11];  // { 31, 59, 90, 120, 151, 181, 212, 243, 273, 304,
                            // 334 };
#endif
  ...
  if ( ( od ) && ( od[0] ) )
    old_datemsk = DuplicateString( od );
  ...
  else
  {
    ...
    int hours = ( days * 24 ) + comp_time->tm_hour -
                ( 1 * ( comp_time->tm_isdst > 0 ) );
#else
    DAYS_SINCE( comp_time->tm_year, days );
    days += ( comp_time->tm_mon ? cum_yday[comp_time->tm_mon - 1] : 0 ) +
            comp_time->tm_mday;
    int hours = ( days * 24 ) + comp_time->tm_hour;
#endif
...
{
  return (ProcessGroupManager *)this->network->groupManagers->findDefinition(
      PROCESS_GROUP );
}
#endif
...
{
  if ( on_or_off == this->resource.showInstanceNumbers )
    return;
  ...
  for ( i = 0; i < netcnt; i++ )
  {
    ...
    if ( i == 0 )
      ...
      net = (Network *)this->macroList.getElement( i );
...
void DXApplication::setServer( char *server )
{
  if ( this->serverInfo.server )
    delete this->serverInfo.server;
