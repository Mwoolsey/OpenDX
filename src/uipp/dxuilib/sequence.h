"//\n", "// time: Wed Mar  5 11:15:47 2003\n", "//\n",
    ...
    "// MODULE main\n", "//\n",
    "// comment: This example creates banded colors for a 2 dimensional data "
    "set. The interactors allow you to specify the break points of the bands, "
    ...
    "    // input[1]: defaulting = 0, visible = 1, type = 67108863, value = "
    "0\n",
    ...
    "    ) [instance: 1, cache: 1];\n", "    // \n",
    "    // node GetGlobal[1]: x = 248, y = 100, inputs = 3, label = "
    "GetGlobal\n",
    "    // input[1]: defaulting = 0, visible = 1, type = 67108863, value = "
    "0\n",
    ...
    "    main_Compute2_3_out_1,\n", "    main_GetLocal_1_out_1\n",
    "    ) [instance: 1, cache: 1];\n", "    // \n",
    "    // node DXLInput[1]: x = 353, y = 10, inputs = 1, label = "
    "_java_control\n",
    "    // input[1]: defaulting = 0, visible = 1, type = 29, value = 0\n",
    "    // page group: java seqno\n", "    //\n",
    "    main_DXLInput_1_out_1 = _java_control;\n", "    // \n",
    "    // node SetGlobal[1]: x = 249, y = 280, inputs = 3, label = "
    "SetGlobal\n",
    "    // page group: java seqno\n", "    //\n", "    SetGlobal(\n",
    "    main_Compute2_2_out_1,\n", "    main_GetGlobal_1_out_2,\n",
    ...
    "    // \n", "    // node Transmitter[3]: x = 57, y = 460, inputs = 1, "
                 "label = java_sequence\n",
    "    // page group: java seqno\n", "    //\n",
    "java_sequence = main_Compute_1_out_1;\n", "    // \n",
    "    // node Transmitter[4]: x = 356, y = 100, inputs = 1, label = "
    "java_control\n",
    "    // page group: java seqno\n", "    //\n",
    "java_control = main_DXLInput_1_out_1;\n", "    //\n",
    "    // decorator Annotate	pos=(330,206) size=235x40 "
