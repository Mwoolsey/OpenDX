...
PostScriptImageFormat::PostScriptImageFormat( const char *name,
...
{
  if ( this->pixel_size_val )
    delete this->pixel_size_val;
  if ( this->size_timer )
...
Widget PostScriptImageFormat::createBody( Widget parent )
{
  ...
  Widget body = XtVaCreateManagedWidget(
      this->name, xmFormWidgetClass, parent, XmNmappedWhenManaged, False,
  ...
  // W I D T H  X  H E I G H T       W I D T H  X  H E I G H T
  //
  Widget lab = XtVaCreateManagedWidget(
      "sizeLabel", xmLabelWidgetClass, body, XmNtopAttachment, XmATTACH_FORM,
      XmNleftAttachment, XmATTACH_FORM, XmNleftOffset, 2, XmNtopOffset, 7,
      XmNalignment, XmALIGNMENT_END, NULL );
  this->size_text = XtVaCreateManagedWidget(
      "sizeText", xmTextWidgetClass, body, XmNtopAttachment, XmATTACH_FORM,
      XmNtopOffset, 2, XmNleftAttachment, XmATTACH_WIDGET, XmNleftWidget, lab,
      XmNleftOffset, 2, XmNcolumns, 10, NULL );
  XtAddCallback( this->size_text, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_ParseSizeCB,
                 ( XtPointer ) this );
  XtAddCallback( this->size_text, XmNmodifyVerifyCallback,
                 (XtCallbackProc)PostScriptImageFormat_ModifyCB,
                 ( XtPointer ) this );
  XtAddEventHandler( this->size_text, LeaveWindowMask, False,
                     (XtEventHandler)PostScriptImageFormat_ParseSizeEH,
                     ( XtPointer ) this );

  XtVaCreateManagedWidget( "pixelsLabel", xmLabelWidgetClass, body,
                           XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
                           this->size_text, XmNleftAttachment, XmATTACH_FORM,
                           XmNleftOffset, 2, XmNtopOffset, 7, XmNalignment,
                           XmALIGNMENT_END, NULL );
  this->pixel_size_text = XtVaCreateManagedWidget(
      "pixelsText", xmTextWidgetClass, body, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, this->size_text, XmNtopOffset, 2, XmNleftAttachment,
      XmATTACH_OPPOSITE_WIDGET, XmNleftWidget, this->size_text, XmNleftOffset,
      0, XmNcolumns, 10, NULL );
  XtAddCallback( this->pixel_size_text, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_ParseSizeCB,
                 ( XtPointer ) this );
  XtAddCallback( this->pixel_size_text, XmNmodifyVerifyCallback,
                 (XtCallbackProc)PostScriptImageFormat_ModifyCB,
                 ( XtPointer ) this );
  ...
  lab = XtVaCreateManagedWidget(
      "pageSizeLabel", xmLabelWidgetClass, body, XmNtopAttachment,
      XmATTACH_WIDGET, XmNtopWidget, this->pixel_size_text, XmNleftAttachment,
      XmATTACH_FORM, XmNleftOffset, 2, XmNtopOffset, 7, XmNalignment,
      XmALIGNMENT_END, NULL );
  char tbuf[64];
  if ( this->isMetric() )
  ...
  this->page_size_text = XtVaCreateManagedWidget(
      "pageSizeText", xmTextWidgetClass, body, XmNtopAttachment,
      XmATTACH_WIDGET, XmNtopWidget, this->pixel_size_text, XmNtopOffset, 2,
      XmNleftAttachment, XmATTACH_OPPOSITE_WIDGET, XmNleftWidget,
      this->size_text, XmNleftOffset, 0, XmNcolumns, 10, XmNvalue, tbuf, NULL );
  XtAddCallback( this->page_size_text, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_ParsePageSizeCB,
                 ( XtPointer ) this );
  XtAddCallback( this->page_size_text, XmNmodifyVerifyCallback,
                 (XtCallbackProc)PostScriptImageFormat_PageModifyCB,
                 ( XtPointer ) this );
  ...
  this->autoorient_button = this->chosen_layout = XtVaCreateManagedWidget(
      "automatic", xmPushButtonWidgetClass, pulldown, NULL );
  this->portrait_button = XtVaCreateManagedWidget(
      "portrait", xmPushButtonWidgetClass, pulldown, NULL );
  this->landscape_button = XtVaCreateManagedWidget(
      "landscape", xmPushButtonWidgetClass, pulldown, NULL );
  n = 0;
  ...
  XtAddCallback( this->autoorient_button, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_OrientCB,
                 ( XtPointer ) this );
  XtAddCallback( this->landscape_button, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_OrientCB,
                 ( XtPointer ) this );
  XtAddCallback( this->portrait_button, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_OrientCB,
                 ( XtPointer ) this );
  ...
  this->dpi_number = XtVaCreateManagedWidget(
      "dpi", xmNumberWidgetClass, body, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, this->page_layout_om, XmNtopOffset, 8, XmNrightAttachment,
      XmATTACH_FORM, XmNrightOffset, 8, XmNdataType, INTEGER, XmNiValue,
      dots_per, XmNcharPlaces, 5, XmNeditable, True, XmNrecomputeSize, False,
      XmNiMinimum, 1, NULL );
  XtAddCallback( this->dpi_number, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_DpiCB,
                 ( XtPointer ) this );
  XtVaCreateManagedWidget(
      "dpiLabel", xmLabelWidgetClass, body, XmNtopAttachment, XmATTACH_WIDGET,
      XmNtopWidget, this->page_layout_om, XmNtopOffset, 12, XmNrightAttachment,
      XmATTACH_WIDGET, XmNrightWidget, this->dpi_number, XmNrightOffset, 2,
      XmNalignment, XmALIGNMENT_BEGINNING, XmNwidth, 110, NULL );
...
//
  ...
  double value = 0.5;
  double min = 0.0;
  double max = MIN( ( ( this->page_width / 2.0 ) - 0.2 ),
                    ( ( this->page_height / 2.0 ) - 0.2 ) );
  if ( this->isMetric() )
    value *= CM_PER_INCH;
  this->margin_width = XtVaCreateManagedWidget(
      "marginWidth", xmNumberWidgetClass, body, XmNtopAttachment,
      XmATTACH_WIDGET, XmNtopWidget, this->dpi_number, XmNtopOffset, 3,
      XmNrightAttachment, XmATTACH_FORM, XmNrightOffset, 8, XmNdataType, DOUBLE,
      XmNdValueStep, DoubleVal( inc, dx_l2 ), XmNdValue,
      DoubleVal( value, dx_l1 ), XmNdecimalPlaces, 2, XmNcharPlaces, 5,
      XmNrecomputeSize, False, XmNfixedNotation, False, XmNeditable, True,
      XmNdMinimum, DoubleVal( min, dx_l3 ), XmNdMaximum,
      DoubleVal( max, dx_l4 ), NULL );
  XtAddCallback( this->margin_width, XmNactivateCallback,
                 (XtCallbackProc)PostScriptImageFormat_MarginCB,
                 ( XtPointer ) this );
  XtVaCreateManagedWidget( "marginSizeLabel", xmLabelWidgetClass, body,
                           XmNtopAttachment, XmATTACH_WIDGET, XmNtopWidget,
                           this->dpi_number, XmNtopOffset, 7,
                           XmNrightAttachment, XmATTACH_WIDGET, XmNrightWidget,
                           this->dpi_number, XmNrightOffset, 2, XmNalignment,
                           XmALIGNMENT_BEGINNING, XmNwidth, 110, NULL );
...
{
  if ( this->ImageFormat::useLocalFormat() )
    return TRUE;
  if ( this->dirty & PostScriptImageFormat::DirtyDpi )
    return TRUE;
  return FALSE;
}
...
boolean PostScriptImageFormat::useLocalResolution()
{
  ...
  if ( ( rescon ) || ( !rerender ) )
    return FALSE;
  return ( ( this->dirty & PostScriptImageFormat::DirtyResolution ) ? TRUE
                                                                    : FALSE );
}
...
boolean PostScriptImageFormat::useLocalAspect()
{
  ...
  if ( ( aspcon ) || ( !rerender ) )
    return FALSE;
  return ( ( this->dirty & PostScriptImageFormat::DirtyAspect ) ? TRUE
                                                                : FALSE );
}
...
void PostScriptImageFormat::setCommandActivation()
{
  ...
  boolean use_nodes_resolution =
      ( rescon || !rerender || ( resset && !dirty_res ) );
  boolean use_nodes_aspect =
      ( aspcon || !rerender || ( aspset && !dirty_asp ) );
  ...
  //
  // If recordFormat is connected (which implies dpi is fixed), and
  // allow-rerendering
  ...
  {
    portrait = new Orientation( this->width, height, this->page_width,
                                this->page_height, mrgn2 );
    landscape = new Orientation( height, this->width, this->page_width,
                                 this->page_height, mrgn2 );
  }
  else
  {
  ...
  //
  if ( ( fmtcon == FALSE ) &&
       ( ( this->dirty & PostScriptImageFormat::DirtyDpi ) == 0 ) )
  {
    this->dpi = chosen_orientation->dpi;
    XtVaSetValues( this->dpi_number, XmNiValue, this->dpi, NULL );
  }
  else if ( fmtcon == TRUE )
  {
    ...
    if ( cp )
    {
      ...
      if ( items_parsed == 1 )
      {
        ...
        XtVaSetValues( this->dpi_number, XmNiValue, dpi, NULL );
      }
    }
  }
...
void PostScriptImageFormat::parseRecordFormat( const char *value )
{
  ...
  if ( ( fmtcon ) ||
       ( ( this->dirty & PostScriptImageFormat::DirtyOrient ) == 0 ) )
  {
  ...
  if ( ( issue_ubd_warning ) &&
       ( PostScriptImageFormat::FmtConnectionWarning == FALSE ) )
  {
    PostScriptImageFormat::FmtConnectionWarning = True;
    char *cp = NUL( char * );
    if ( theDXApplication->appAllowsEditorAccess() == FALSE )
      cp = "The value for the \'recordFormat\' input parameter of your\n"
      ...
      cp = "The value for the \'recordFormat\' input parameter of your image\n"
...
void PostScriptImageFormat::restore()
{
  ...
  if ( this->size_timer )
    XtRemoveTimeOut( this->size_timer );
  if ( this->page_size_timer )
    XtRemoveTimeOut( this->page_size_timer );
  this->size_timer = 0;
  this->page_size_timer = 0;
  this->entered_dims_valid = FALSE;
  this->parsePageSize( RESET_PAGE );
  ...
  if ( this->isMetric() )
    ...
    sprintf( tbuf, PAGE_SIZE_FMT, this->page_width, this->page_height );
  this->setTextString( this->page_size_text, tbuf,
                       (void *)PostScriptImageFormat_PageModifyCB );
  ...
  if ( this->isMetric() )
    value *= CM_PER_INCH;
  XtVaSetValues( this->margin_width, XmNdValue, DoubleVal( value, dx_l1 ),
                 NULL );
}
...
void PostScriptImageFormat::parseImageSize( const char *str )
{
  ...
  if ( ( this->dialog->isRerenderAllowed() ) && ( this->entered_dims_valid ) )
  {
    ...
    if ( ( hd - height ) >= 0.5 )
      height++;
    Orientation portrait( this->width, height, this->entered_printout_width,
                          this->entered_printout_height, 0.0, FALSE );
    Orientation landscape( height, this->width, this->entered_printout_width,
                           this->entered_printout_height, 0.0, FALSE );
    Orientation *chosen_orientation = NUL( Orientation * );
    if ( this->chosen_layout == this->autoorient_button )
    {
...
void PostScriptImageFormat::parsePictureSize( const char *str )
{
  ...
  else
  {
    ...
    {
      char msg[256];
      sprintf( msg, "These values (%s) would change the\n%s\n%s", str,
  ...
  if ( node->isRecordFormatConnected() == FALSE )
  {
    ...
    if ( this->dialog->isRerenderAllowed() )
    {
      ...
      if ( width_parsed )
        new_resolution = dwidth * this->dpi;
      else
        new_resolution = ( dheight / this->aspect ) * this->dpi;
      this->width = (int)new_resolution;
      if ( ( new_resolution - this->width ) > 0.5 )
        this->width++;
      this->dirty |= PostScriptImageFormat::DirtyResolution;
    }
  }
...
void PostScriptImageFormat::parsePageSize( const char *str )
{
  ...
  if ( this->margin_width )
  {
    ...
    if ( mrgn > max_mrgn )
    {
      XtVaSetValues( this->margin_width, XmNdValue,
                     DoubleVal( max_mrgn, dx_l2 ), XmNdMaximum,
                     DoubleVal( max_mrgn, dx_l1 ), NULL );
    }
    else
    {
      XtVaSetValues( this->margin_width, XmNdMaximum,
                     DoubleVal( max_mrgn, dx_l1 ), NULL );
    }
  }
}
...
boolean PostScriptImageFormat::setVerifiedSizeTextString( double width,
                                                          double height )
{
  char tbuf[64];
  ...
  Orientation portrait( this->width, ih, this->page_width, this->page_height,
                        mrgn2 );
  Orientation landscape( ih, this->width, this->page_width, this->page_height,
                         mrgn2 );
  Orientation *chosen_orientation = NUL( Orientation * );
  ...
  {
    if ( ( width + mrgn ) > this->page_height )
      size_valid = FALSE;
    else if ( ( height + mrgn ) > this->page_width )
      size_valid = FALSE;
  }
  else
  {
    ASSERT( chosen_orientation == &portrait );
    if ( ( height + mrgn ) > this->page_height )
      size_valid = FALSE;
    else if ( ( width + mrgn ) > this->page_width )
      size_valid = FALSE;
  }
...
void PostScriptImageFormat::shareSettings( ImageFormat *imgfmt )
{
  ...
  if ( imgfmt->useLocalFormat() )
  {
    ...
    if ( imgfmt->isA(
            theSymbolManager->registerSymbol( ClassPostScriptImageFormat ) ) )
      this->dirty |= PostScriptImageFormat::DirtyDpi;
  }
  else if ( imgfmt->isA( theSymbolManager->registerSymbol(
               ClassPostScriptImageFormat ) ) )
  {
    this->dirty &= ~PostScriptImageFormat::DirtyDpi;
    if ( this->dirty & PostScriptImageFormat::DirtyPageSize )
    {
...
void PostScriptImageFormat::setTextString( Widget w, char *value,
                                           void *modifyCB )
{
  if ( w )
  {
    XtRemoveCallback( w, XmNmodifyVerifyCallback, (XtCallbackProc)modifyCB,
                      ( XtPointer ) this );
    XmTextPosition tpos = XmTextGetInsertionPosition( w );
    XmTextSetString( w, value );
    XmTextSetInsertionPosition( w, tpos );
    XtAddCallback( w, XmNmodifyVerifyCallback, (XtCallbackProc)modifyCB,
                   ( XtPointer ) this );
  }
}
...
void PostScriptImageFormat_DpiCB( Widget, XtPointer clientData, XtPointer )
{
  ...
  if ( pif->dialog->isRerenderAllowed() )
  {
    ...
    else
    {
      ...
      if ( ( new_resolution - pif->width ) > 0.5 )
        pif->width++;
...
void PostScriptImageFormat_ModifyCB( Widget w, XtPointer clientData, XtPointer )
{
  ...
  if ( w == pif->pixel_size_text )
    pif->size_timer =
        XtAppAddTimeOut( theApplication->getApplicationContext(), 2000,
                         (XtTimerCallbackProc)PostScriptImageFormat_PixelSizeTO,
                         (XtPointer)pif );
  else
    pif->size_timer = XtAppAddTimeOut(
        theApplication->getApplicationContext(), 2000,
        (XtTimerCallbackProc)PostScriptImageFormat_SizeTO, (XtPointer)pif );
}

void PostScriptImageFormat_ParseSizeEH( Widget w, XtPointer clientData,
                                        XEvent *, Boolean * )
{
  PostScriptImageFormat *pif = (PostScriptImageFormat *)clientData;
  ASSERT( pif );
...
void PostScriptImageFormat_ParseSizeCB( Widget w, XtPointer clientData,
                                        XtPointer )
{
  PostScriptImageFormat *pif = (PostScriptImageFormat *)clientData;
  ASSERT( pif );
...
void PostScriptImageFormat_PageModifyCB( Widget, XtPointer clientData,
                                         XtPointer )
{
  PostScriptImageFormat *pif = (PostScriptImageFormat *)clientData;
  ASSERT( pif );
  ...
  pif->page_size_timer = XtAppAddTimeOut(
      theApplication->getApplicationContext(), 2000,
      (XtTimerCallbackProc)PostScriptImageFormat_PageSizeTO, (XtPointer)pif );
  pif->dirty |= PostScriptImageFormat::DirtyPageSize;
  pif->dirty &= ~PostScriptImageFormat::DirtyDpi;
}

void PostScriptImageFormat_ParsePageSizeCB( Widget w, XtPointer clientData,
                                            XtPointer )
{
  PostScriptImageFormat *pif = (PostScriptImageFormat *)clientData;
  ASSERT( pif );
