...
//
extern "C" void ProcessGroupOptionsDialog_NumberTextCB( Widget, XtPointer,
                                                        XtPointer );
extern "C" void ProcessGroupOptionsDialog_ToggleCB( Widget, XtPointer,
                                                    XtPointer );
...
class ProcessGroupOptionsDialog : public Dialog
{
 ...
 protected:
  ...
  friend void ProcessGroupOptionsDialog_ToggleCB( Widget w,
                                                  XtPointer clientData,
                                                  XtPointer );
  friend void ProcessGroupOptionsDialog_NumberTextCB( Widget w,
                                                      XtPointer clientData,
                                                      XtPointer );
